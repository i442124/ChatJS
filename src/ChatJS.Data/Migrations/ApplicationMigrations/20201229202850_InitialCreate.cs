        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameCaption = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayNameUid = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Memberships", x => new { x.UserId, x.ChatroomId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_DisplayName_DisplayNameUid",
                table: "Users",
                columns: new[] { "DisplayName", "DisplayNameUid" },
                unique: true,
                filter: "[DisplayName] IS NOT NULL AND [DisplayNameUid] IS NOT NULL");
        }
